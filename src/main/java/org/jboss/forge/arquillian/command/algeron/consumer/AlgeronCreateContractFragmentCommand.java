...
public class AlgeronCreateContractFragmentCommand extends AbstractProjectCommand implements UICommand {
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.from(super.getMetadata(context), getClass())
            ...
            .name("Arquillian Algeron: Create Contract Fragment") // arquillian-algeron-create-contract-fragment
